...
def record_and_transcribe(p, stream, model, chunk_length=3, threshold=100):
    frames = []
    silent_chunks = 0
    ...
    for _ in range(0, int(16000 / 1024 * chunk_length)):
        ...
        is_silent_chunk, volume = is_silent(audio_data, threshold)
...
def main():
    ...
    threshold = 300  # Starting threshold, adjust as needed
    
    try:
        while True:
            transcription = record_and_transcribe(p, stream, model, threshold=threshold)
            ...
            if transcription:
                ...
                print("\nListening... (no speech detected)", end="\r")
